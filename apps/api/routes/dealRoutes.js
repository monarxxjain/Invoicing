...
const { addDeal, investDeal, verifyDeal, breakDeal, getSellerDeals } = require('../controllers/seller/DealController')
...
router.get('/getSellerDeals',authorization, roleAuthorization(["SELLER", "ADMIN"]) , getSellerDeals)
