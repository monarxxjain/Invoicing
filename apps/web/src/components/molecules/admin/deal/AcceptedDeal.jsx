    ...
    <div className='relative h-full'>
      ...
      <div className={`border h-full border-blue-500 bg-white rounded p-6 flex flex-col gap-5`}>
        ...
        <section className='flex justify-between gap-10 text-gray-700 cursor-pointer font-medium mt-4'>
          ...
          <div className='flex justify-between gap-6'>
            <Button onClick={() => {setOpenModal("FINAL")}} color='success' variant='contained'>
      ...
      >
         <div style={style} className='flex flex-col bg-white rounded'>
            ...
            <p className='px-5 py-3 text-[#061c37]'>Do you want to Transfer money to the Seller ?</p>
            <div className='flex gap-6 px-5 py-3 justify-between'>
              ...
              <LoadingButton className='loading-button' loadingPosition='end' loading={loading} color='success' variant='outlined' onClick={() => handleSubmit()} ><div className={`${loading && "me-3"}`}>Transfer</div></LoadingButton>
            </div>
        </div>
