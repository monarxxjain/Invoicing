...
const FreezedDeal = ({ deal }) => {
  ...
  return (
    <div className='relative h-full'>
      <div  onClick={() => {router.push(`/seller/deals/${deal.id}`)}} className={`absolute cursor-pointer left-8 z-10 -top-3 border  rounded px-10 text-sm  border-gray-500 bg-gray-200 text-gray-700`}>
        ICT{deal.id}
      </div>
      <div className={`border h-full border-gray-500 bg-white rounded p-6 flex flex-col gap-5`}>
